...
import { usePostAccusePost } from '@/apis/community';
...
const reasonList = [
  { key: 'UNFIT_TOPIC', value: '토픽에 관련없는 내용' },
  { key: 'INAPPROPRIATE_CONTENT', value: '음란성, 욕설 등 부적절한 내용' },
  { key: 'CONTAINS_PERSONAL_INFO', value: '개인정보 노출을 포함한 글' },
  { key: 'REPEATED_CONTENTS', value: '중복 / 도배성 글' },
  { key: 'ADVERTISEMENT', value: '광고, 홍보성 글' },
...
export const AccuseCommentContainer = () => {
  ...
  return (
    <AccuseComponent
      headerText={type === 'COMMENT' ? '댓글 신고하기' : '게시글 신고하기'}
      title={type === 'COMMENT' ? '댓글을 신고하는\n이유를 알려주세요!' : '게시글을 신고하는\n이유를 알려주세요!'}
