...
export const useCommunityBottomSheetNavigation = () => {
  ...
  const goNavEdit = useCallback(
    ({ targetPostId, targetPostTopic }: GoNavEditProps) => {
  ...
  const goNavAccuse = useCallback(
    ({ targetPostId, targetPostTopic }: GoNavAccuseProps) => {
  ...
  const goNavSuccessBottomSheet = useCallback(
    ({ content, onConfirmCallback }: GoNavSuccessBottomSheetProps) => {
  ...
  const goNavDeleteBottomSheet = useCallback(
    ({ onPressLeftButton }: GoNavDeleteBottomSheetProps) => {
  ...
  const goNavBlockUserBottomSheet = useCallback(
    ({ onPressRightButton }: GoNavBlockUserBottomSheetProps) => {
      navigation.navigate('QuestionBottomSheet', {
